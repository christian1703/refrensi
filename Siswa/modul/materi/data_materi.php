...
<h4>
 <b>MATERI</b>
<small class="text-muted">/ Semua Materi
                ...
                <div class="card-body">
                 ...
                 <thead>
                    ...
                    <tbody>
                      ...
                      INNER JOIN tb_master_jurusan ON tb_roleguru.id_jurusan=tb_master_jurusan.id_jurusan WHERE tb_roleguru.id_kelas='$data[id_kelas]' AND tb_roleguru.id_jurusan='$data[id_jurusan]' ");
