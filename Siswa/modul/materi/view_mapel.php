...
<div class="row">
	<div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">MATERI <b><?= $_GET['mp']; ?></b></h4>
              ...
              <table class="table table-condensed table-striped table-hover">
                 <thead>
                    ...
                    <tbody>
                      ...
                      INNER JOIN tb_master_jurusan ON tb_roleguru.id_jurusan=tb_master_jurusan.id_jurusan WHERE tb_roleguru.id_kelas='$data[id_kelas]' AND tb_roleguru.id_jurusan='$data[id_jurusan]' AND tb_roleguru.id_mapel='$_GET[ID]' ");
