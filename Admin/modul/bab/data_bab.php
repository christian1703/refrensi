<div class="content-wrapper">
    <h4> <b>Belajar</b> <small class="text-muted">/ Bab</small>
    </h4>
    <hr>
    <div class="row">
        <div class="col-md-10">
            <div class="card">
                ...
                <a data-toggle="modal" data-target="#add" class="btn btn-info text-white pull-right"><i class="fa fa-plus"></i> Tambah</a> <br>
                </p>
                <h4 class="card-title">Data BAB</h4>
                    <div class="table-responsive">
                        ...
                        <tr>
                            ...
                            <a href="?page=bab&act=del&id=<?=$d['id_semester']?>" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Del</a>
                            <div class="modal fade" id="edit<?=$d['id_semester']?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                            <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header"><h4 class="modal-title"> Edit BAB</h4></div>
                                <form action="" method="post">
                                    ...
                                    if (isset($_POST['edit'])) {
                                        ...
                                        if ($sql) {
                                            ...
                                            window.location.replace('?page=bab');
                                            } ,3000);   
                                            </script>";                       
                                        }                   
                                    }
...
<div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header"><h4 class="modal-title"> Tambah BAB </h4></div>
            <form action="" method="post">
                <div class="modal-body">
                    <div class="form-group">
                    <label for="semester"> Nama BAB</label>
                    <input type="text" id="semester" name="semester" class="form-control" placeholder="Nama BAB">                    
                    </div>
                </div>
                <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
