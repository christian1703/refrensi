                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      <p class="card-description text-center">
                          <img src="../pelengkap/images/img_Guru/<?=$data['foto']; ?>" style="border:3px solid black;width: 100px;height: 100px;border-radius: 7px;"/>
                      </p>
...
unlink('../pelengkap/images/img_Guru/'.$imagee['foto']);
						move_uploaded_file($_FILES['foto']['tmp_name'],"../pelengkap/images/img_Guru/$gambar");
