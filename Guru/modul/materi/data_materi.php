  ...
  <h4>
  Materi <small class="text-muted">/ Semua Materi</small>
  </h4>
<hr>
                ...
                <div class="card-body">
                  ...
                  <table class="table table-condensed table-hover" id="data">
                    ...
                    <tbody>
                      ...
                      WHERE tb_roleguru.id_guru='$sesi' ORDER BY id_materi DESC ");
                      ...
                      <tr>
                       <td><?=$no++; ?>.</td>
                        ...
                        <td>
                          <a data-toggle="modal" data-target="#<?=$row['id_materi']; ?>" class="btn btn-light"> <img class="menu-icon" src="../pelengkap/images/menu_icons/04.png" alt="menu icon"> View Materi</a>
                        ...
                        <div class="modal-content">
                          <div class="modal-header">
                            ...
                            <h4 class="modal-title">
                              ...
                              <img class="menu-icon" src="../pelengkap/images/menu_icons/04.png" alt="menu icon"> <b> <?=$row['judul_materi']; ?></b> | <?=$row['mapel']; ?> KELAS <?=$row['kelas']; ?>-<?=$row['jurusan']; ?> </h4>
                              <hr>
                          </div>
